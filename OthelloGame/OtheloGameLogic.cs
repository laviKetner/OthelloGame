                ...
                case (byte)eBoardSize.Small:
                    {
                        ...
                        { { 16.16f , -3.03f,  0.99f,  0.99f , -3.60f,  16.16f},
                          { -4.60f , -1.81f, -0.08f, -0.08f , -1.81f, -4.60f },
                          { 1.33f  , -0.04f,  0.51f,  0.51f , -0.04f,  1.33f },
                          { 1.33f  , -0.04f,  0.51f,  0.51f , -0.04f,  1.33f },
                          { -4.60f , -1.81f, -0.08f, -0.08f , -1.81f, -4.60f },
                          { 16.16f , -3.60f,  0.99f,  0.99f , -3.60f,  16.16f} };
                ...
                case (byte)eBoardSize.Medium:
                    {
                        ...
                        { { 16.16f ,-3.60f,  0.99f,  0.43f,  0.43f,  0.99f , -3.60f,  16.16f},
                          { -4.60f ,-1.81f, -0.08f, -0.27f, -0.27f, -0.08f , -1.81f, -4.60f },
                          { 1.33f  ,-0.04f,  0.51f,  0.07f,  0.07f,  0.51f , -0.04f,  1.33f },
                          { 0.63f  ,-0.18f, -0.04f,  0.01f,  0.01f, -0.04f , -0.18f,  0.63f },
                          { 0.63f  ,-0.18f, -0.04f,  0.01f,  0.01f, -0.04f , -0.18f,  0.63f },
                          { 1.33f  ,-0.04f,  0.51f,  0.07f,  0.07f,  0.51f , -0.04f,  1.33f },
                          { -4.60f ,-1.81f, -0.08f, -0.27f, -0.27f, -0.08f , -1.81f, -4.60f },
                          { 16.16f ,-3.03f,  0.99f,  0.43f,  0.43f,  0.99f , -3.60f,  16.16f} };
                ...
                case (byte)eBoardSize.Large:
                    {
                        ...
                        { { 16.16f ,-3.60f,  0.99f,  0.43f,  0.55f,  0.55f  , 0.43f,  0.99f , -3.60f,  16.16f},
                          { -4.60f ,-1.81f, -0.08f, -0.27f, -0.15f, -0.15f , -0.27f, -0.08f , -1.81f, -4.60f },
                          { 1.33f  ,-0.04f,  0.51f,  0.07f,  0.07f,  0.07f ,  0.07f,  0.51f , -0.04f,  1.33f },
                          { 0.63f  ,-0.18f, -0.04f, -0.01f,  0.02f,  0.02f , -0.01f, -0.04f , -0.18f,  0.63f },
                          { 0.73f  ,-0.14f,  0.02f,  0.01f,  0.20f,  0.20f ,  0.01f,  0.02f , -0.14f,  0.73f },
                          { 0.73f  ,-0.14f,  0.02f,  0.01f,  0.20f,  0.20f ,  0.01f,  0.02f , -0.14f,  0.73f },
                          { 0.63f  ,-0.18f, -0.04f, -0.01f,  0.02f,  0.02f , -0.01f, -0.04f , -0.18f,  0.63f },
                          { 1.33f  ,-0.04f,  0.51f,  0.07f,  0.07f,  0.07f ,  0.07f,  0.51f , -0.04f,  1.33f },
                          { -4.60f ,-1.81f, -0.08f, -0.27f, -0.15f, -0.15f , -0.27f, -0.08f , -1.81f, -4.60f },
